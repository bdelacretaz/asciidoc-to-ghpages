...
.Le Château de Muzot
[caption=""]
image::muzot-from-notrehistoire-ch.jpg[]

Entre commissions, arrosage de rosiers et soins aux jardins, elle aide la gouvernante des lieux, Mlle Baumgartner, qui est elle-même au service de M.Reinhart,
locataire puis propriétaire du château. Quelques années auparavant, le poète Rilke a résidé à Muzot et y a passé les dernières années de sa vie (de 1921
à 1926). Depuis, M.Reinhart le prête régulièrement aux artistes en recherche d'un lieu calme où créer et écrire. Tante Nelly y restera employée pendant
6 ans, et reviendra souvent en visite ou pour donner des coups de main.
